	...
	<div class="rounded">
		...
		<div id="contents" class="two_third first">
			<div class="sdb_holder">
				...
				<c:if test="${sessionScope.loginId ne null}">
					<c:if test="${product.maker.id eq sessionScope.loginId}">
						...
						<div align="center">
							<%-- 
							<input class="btn btn-warning" type="button" value="삭제" onclick="window.location='${ctx }/product/delete.do?productId=${product.id}'">
							--%>
							<input class="btn btn-warning" type="button" value="삭제" onclick="deleteProduct(${product.id})">
							<input class="btn btn-warning" type="button" value="수정" onclick="location.href='${ctx}/product/ui/modify.do?id=${product.id}';">
						</div>
					</c:if>
				</c:if>
				<br>
			...
			<div id="reviews">
				...
				<form class="clear">
					<div>
						<input type="button" onclick="javascript:Reviews(${product.id})" value="전체 댓글">
						<input type="button" onclick="javascript:myReview(1,${product.id})" value="내가 작성한 댓글">
						<fieldset>
