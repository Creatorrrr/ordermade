...
${box2 }
				...
				<form id="productModify">
					<table class="table">
						...
						<tr>
							...
							<td>
								...
								<div><img id='productImage' src="${ctx }/main/file/download.do?fileName=${product.image }" style="width:100px"></div>
								<input id="productImageHidden" name="image" type="hidden" value="${product.image }">
							</td>
						<tr>
						<tr>
							<th>금액 <span>*</span></th>
					...
					<div align="center">
						...
						<input class="btn btn-default" type="reset" value="취소하기" onclick="javascript:window.location='${ctx }/product/ui/detail.do?id=${product.id }'">
