...
<div class="wrapper row3">
	<div class="rounded">
		...
		<div id="content" class="two_third">
			<h1>포트폴리오 수정 페이지</h1>
			<br>
			<form action="${ctx }/portfolio/xml/modify.do" method="post" name="pModify"
				...
				<table class="table">
					...
					<tr>
						...
						<td><input id="title" name="title"
							class="form-control" type="text" value="">${portfolio.title }</td>
					<tr>
					<tr>
						<th>표지 이미지</th>
						<td><input id="image" name="image" class="btn btn-success" type="file"
							value="찾아보기"></td>
					<tr>
					<tr>
