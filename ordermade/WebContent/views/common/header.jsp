...
<div class="wrapper row0">
	<div id="topbar" class="clear" style="padding-top: 10px;">
		...
		<div id="logo" class="fl_left heading" style="line-height: 70px; font-size: 60px; margin: 0px;">
			<a href="${ctx }/views/index.jsp">
				<img src="${ctx }/views/images/panda4.jpg" style="width: 70px; height: 70px"><b>판다</b></a>
			<div id="z" style= "font-size:15px; margin-left:50px"><p>1:1 매칭 서비스</p></div>
		</div>
...
<div class="wrapper row2">
	<div
		style="padding:160px 10px 30px 10px;background-image: url('${ctx}/resources/imgs/mainbaner.jpg'); background-position:center center"">
		<div>
	...
	<div class="rounded">
		<nav id="mainav" class="clear">
			<ul class="clear">
				...
				<li><a class="drop" href="${ctx }/product/ui/search.do">상품
						목록</a>
					<ul>
				...
				<li><a class="drop" href="${ctx }/portfolio/ui/search.do">포트폴리오
						목록</a>
					<ul>
						<c:forEach items="${categories }" var="category">
							<li><a
				...
				<c:choose>
					<c:when test="${sessionScope.memberType eq 'C' }">
						<li><a href="${ctx }/request/ui/consumerInviteList.do?page=1">참가
								요청내역</a></li>
					</c:when>
					<c:when test="${sessionScope.memberType eq 'M' }">
						<li><a href="${ctx }/request/ui/makerInviteList.do?page=1">참가
								요청내역</a></li>
					</c:when>
				</c:choose>
