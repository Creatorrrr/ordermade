...
public interface PurchaseHistoryMapper {
	...
	public List<PurchaseHistory> selectPurchaseHistoriesByConsumerIdAndRequestTitle(@Param("consumerId")String consumerId, @Param("requestTitle")String requestTitle, @Param("page")String page);
